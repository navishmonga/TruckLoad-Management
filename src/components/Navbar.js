...
const  Navbar=() =>{
  return (
    <nav className="bg-gray-800 flex p-3">
        <button className="bg-gray-800 hover:text-amber-500 text-2xl italic rounded-full p-2 px-3"><Link to="/">DatApp</Link></button>
        <span className="flex-1 text-4xl font-bold pb-1">Revolutionize your Dispatching</span>
        <div className="flex">
        <button className="bg-gray-800 hover:bg-cyan-400 text-lg rounded-full p-2 px-3"><Link to="/">My Orders</Link></button>
